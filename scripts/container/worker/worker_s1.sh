...
MHUB_DOCKER_IMAGE_TAG=${1:-"latest"}
...
retry 10 docker pull registry.gitlab.eox.at/maps/mapchete_hub/mhub-s1:$MHUB_DOCKER_IMAGE_TAG
...
docker run \
  ...
  -d \
  registry.gitlab.eox.at/maps/mapchete_hub/mhub-s1:$MHUB_DOCKER_IMAGE_TAG \
