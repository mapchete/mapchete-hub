...
RUN pip install --upgrade pip setuptools wheel && \
    ...
    git+http://gitlab+deploy-token-3:SV2HivQ_xiKVxSVEtYCr@gitlab.eox.at/maps/mapchete_satellite.git@80b1f351091e5ef68cf9619e9e4b342283508057 \
